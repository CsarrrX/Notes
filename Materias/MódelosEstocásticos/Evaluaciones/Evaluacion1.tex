...
\section*{Solutions}
        ...
        A password is formed with the letters ${A, B, C, D, E, F}$
            \begin{enumerate}[label=\alph*)]
               ...
               n! = 5! = 120               
                ...
                4!\cdot 2!\cdot 2! = 96
                \]
                Therefore, we can create \textbf{96} passwords where $A$ is before of $B$ and $C$ is before $D$.
    ...
    \end{minipage}
        ...
        \begin{solutions}
            ...
            \[
            \#A = 13\cdot4\cdot12\cdot6
            \]We know that,
            \[
            \Omega = 52!
            \]Therefore, the classical probability of getting a full house is:
            \[
            \mathbf{P(A)} = \frac{\mathbf{13\cdot4\cdot12\cdot6}}{\mathbf{52!}} = \frac{\mathbf{3744}}{\mathbf{52!}}
            \]
            \medskip
        \end{solutions}
        ...
        \begin{solutions}
            ...
            \[
            \binom{10}{5} = \frac{10!}{(10-5)!\cdot5!} = 252
            \]
        ...
        \begin{solutions}
            ...
            \]
            \noindent b) We can calculate this probability by making the 4 balls a single "block", and we also need the cardinality of $\Omega$:
            \[ 
